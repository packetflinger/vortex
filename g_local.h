...
extern armoryRune_t WeaponRunes[ARMORY_MAX_RUNES];
extern armoryRune_t AbilityRunes[ARMORY_MAX_RUNES];
extern armoryRune_t ComboRunes[ARMORY_MAX_RUNES];
